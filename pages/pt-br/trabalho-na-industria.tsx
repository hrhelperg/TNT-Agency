...
export default function WorkInManufacturingPtBRPage() {
  return <LocalePage conceptId="work-in-manufacturing" locale="pt-BR" content={PTBR_CONTENT['work-in-manufacturing']['pt-BR']!} />
}
