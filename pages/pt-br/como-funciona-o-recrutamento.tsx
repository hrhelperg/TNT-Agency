...
export default function HowRecruitmentWorksPtBRPage() {
  return <LocalePage conceptId="how-recruitment-works" locale="pt-BR" content={PTBR_CONTENT['how-recruitment-works']['pt-BR']!} />
}
