...
export default function VerifyOfficialInfoPtBRPage() {
  return <LocalePage conceptId="verify-official-info" locale="pt-BR" content={PTBR_CONTENT['verify-official-info']['pt-BR']!} />
}
