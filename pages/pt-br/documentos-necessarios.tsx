...
export default function DocumentsRequiredPtBRPage() {
  return <LocalePage conceptId="documents-required" locale="pt-BR" content={PTBR_CONTENT['documents-required']['pt-BR']!} />
}
