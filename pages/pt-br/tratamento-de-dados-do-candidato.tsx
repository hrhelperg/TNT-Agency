...
export default function CandidateDataNoticePtBRPage() {
  return <LocalePage conceptId="candidate-data-notice" locale="pt-BR" content={PTBR_CONTENT['candidate-data-notice']['pt-BR']!} />
}
