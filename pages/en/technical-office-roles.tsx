...
export default function TechnicalOfficeRolesEnPage() {
  return <LocalePage conceptId="technical-office-roles" locale="en" content={EN_CONTENT['technical-office-roles'].en!} />
}
