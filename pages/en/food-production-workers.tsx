...
export default function FoodProductionWorkersEnPage() {
  return <LocalePage conceptId="food-production-workers" locale="en" content={EN_CONTENT['food-production-workers'].en!} />
}
