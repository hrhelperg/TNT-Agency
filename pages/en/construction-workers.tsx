...
export default function ConstructionWorkersEnPage() {
  return <LocalePage conceptId="construction-workers" locale="en" content={EN_CONTENT['construction-workers'].en!} />
}
