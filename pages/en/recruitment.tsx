...
export default function RecruitmentOverviewEnPage() {
  return <LocalePage conceptId="recruitment-overview" locale="en" content={EN_CONTENT['recruitment-overview'].en!} />
}
