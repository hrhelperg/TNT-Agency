...
export default function PurchasingAndSupplyEnPage() {
  return <LocalePage conceptId="purchasing-and-supply" locale="en" content={EN_CONTENT['purchasing-and-supply'].en!} />
}
