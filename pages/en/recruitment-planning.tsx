...
export default function RecruitmentPlanningEnPage() {
  return <LocalePage conceptId="recruitment-planning" locale="en" content={EN_CONTENT['recruitment-planning'].en!} />
}
