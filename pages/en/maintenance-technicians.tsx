...
export default function MaintenanceTechniciansEnPage() {
  return <LocalePage conceptId="maintenance-technicians" locale="en" content={EN_CONTENT['maintenance-technicians'].en!} />
}
