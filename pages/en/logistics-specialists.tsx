...
export default function LogisticsSpecialistsEnPage() {
  return <LocalePage conceptId="logistics-specialists" locale="en" content={EN_CONTENT['logistics-specialists'].en!} />
}
