    ...
    <>
      ...
      <section className="page-hero" id="home">
        <div className="container">
          <div className="eyebrow eyebrow--light fi" data-i18n="pages.submitOffEyebrow">Poptávka klienta</div>
          <h1 className="fi d1" data-i18n="pages.submitOffH1">Zadejte poptávku</h1>
          <p className="page-hero__sub fi d2" data-i18n="pages.submitOffSub">Napište nám, co potřebujete, a my vaši poptávku předáme relevantním agenturám. Vše prochází ruční kontrolou provozovatele – nic se nezveřejňuje automaticky.</p>
        </div>
        ...
        <div className="container">
          <div className="submit-wrap">
            <div className="contact-cta-card contact-cta-card--wide">
              ...
              <p data-i18n="pages.submitOffCardBody">Napište nám e-mail a uveďte firmu, o jaké pracovníky máte zájem, počet, lokalitu, směnový model a požadovaný termín nástupu. Ozveme se vám.</p>
              <a
