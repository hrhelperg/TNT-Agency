...
export default function WorkInManufacturingEsPage() {
  return <LocalePage conceptId="work-in-manufacturing" locale="es" content={ES_CONTENT['work-in-manufacturing'].es!} />
}
