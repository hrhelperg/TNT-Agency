...
export default function QualificationRecognitionEsPage() {
  return <LocalePage conceptId="qualification-recognition" locale="es" content={ES_CONTENT['qualification-recognition'].es!} />
}
