...
export default function RecruitmentPlanningDePage() {
  return <LocalePage conceptId="recruitment-planning" locale="de" content={DE_CONTENT['recruitment-planning'].de!} />
}
