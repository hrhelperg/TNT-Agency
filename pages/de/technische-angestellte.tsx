...
export default function TechnicalOfficeRolesDePage() {
  return <LocalePage conceptId="technical-office-roles" locale="de" content={DE_CONTENT['technical-office-roles'].de!} />
}
