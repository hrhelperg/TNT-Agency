...
export default function MaintenanceTechniciansDePage() {
  return <LocalePage conceptId="maintenance-technicians" locale="de" content={DE_CONTENT['maintenance-technicians'].de!} />
}
