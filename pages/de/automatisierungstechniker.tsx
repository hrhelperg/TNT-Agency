...
export default function AutomationTechniciansDePage() {
  return <LocalePage conceptId="automation-technicians" locale="de" content={DE_CONTENT['automation-technicians'].de!} />
}
