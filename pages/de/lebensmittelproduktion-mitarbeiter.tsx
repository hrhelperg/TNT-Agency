...
export default function FoodProductionWorkersDePage() {
  return <LocalePage conceptId="food-production-workers" locale="de" content={DE_CONTENT['food-production-workers'].de!} />
}
