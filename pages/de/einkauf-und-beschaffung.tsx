...
export default function PurchasingAndSupplyDePage() {
  return <LocalePage conceptId="purchasing-and-supply" locale="de" content={DE_CONTENT['purchasing-and-supply'].de!} />
}
