...
export default function RecruitmentOverviewDePage() {
  return <LocalePage conceptId="recruitment-overview" locale="de" content={DE_CONTENT['recruitment-overview'].de!} />
}
