...
export default function ConstructionWorkersDePage() {
  return <LocalePage conceptId="construction-workers" locale="de" content={DE_CONTENT['construction-workers'].de!} />
}
