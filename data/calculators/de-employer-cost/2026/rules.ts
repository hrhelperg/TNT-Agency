...
export const DE_RULES_2026: DeRuleset2026 = {
  ...
  care: {
    ...
    saxonyEmployeeExtraPoints: {
      ...
      status: 'confirmed-official',
      note:
        'Saxony alone. THE STATUTE, § 58 Absatz 3 Satz 1 SGB XI, verbatim: "Die in Absatz 1 genannten Beschäftigten tragen die Beiträge in Höhe von 1 vom Hundert allein" — the EMPLOYEE bears one percentage point ALONE — and Satz 3, "Im Übrigen findet Absatz 1 Anwendung", halves the rest. So 3,6 % becomes 1,0 to the employee plus 2,6 halved: 2,3 % employee against 1,3 % employer. The engine reaches the same two numbers from the other end, subtracting this value and halving the remainder for the employer, which is arithmetically identical and is why the figures have always been right. TWO EARLIER VERSIONS OF THIS NOTE WERE WRONG ABOUT THE MECHANISM. One said the employee bears a point on top of half, which would give 2,8/0,8. The other said Absatz 3 derives the EMPLOYER share from a rate reduced by one point and leaves the employee the remainder — that wording exists, but in Absatz 5, and Absatz 5 reaches only the Übergangsbereich and § 7 Absatz 2 SGB V cases through § 249 Absatz 3 und 4 SGB V, both of which this calculator refuses. Relative to the ordinary 1,8/1,8 split the effect is half a point moved across, so prose saying "half a point" and prose saying "one point" are both correct from different baselines.',
    },
    monthlyCeilingCent: {
      value: eur(5_812, 50),
      sourceId: S.svRechgr,
