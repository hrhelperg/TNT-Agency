...
export const EN_EMPLOYER: LocaleCorpus = {
  'recruitment-overview': {
    en: {
      ...
      description:
        'Recruiting for operational and technical roles: direct hiring, agency employment and recruiting from abroad, and when each route makes sense. A decision framework, not legal advice.',
      ...
      sections: [
        {
          ...
          body: [
            'Direct recruitment means the company finds, selects and employs people itself. Agency employment moves part of the administration and flexibility to a staffing agency, which assigns workers temporarily. Recruiting from abroad widens the pool of candidates but adds the administration attached to permits.',
        ...
        },
        {
          ...
          body: [
            ...
            'Seasonal peaks and temporary gaps usually suit agency employment. Key permanent roles usually suit direct recruitment.',
          ],
        },
        {
      ...
      sections: [
        {
          ...
          body: [
            ...
            'A usable description answers what the person will actually do in their first three months, what and who they will work with, and how anyone will know they are coping. Both the advertisement and the interview questions can be derived from a description like that.',
          ],
        },
        {
        ...
        },
        {
          ...
          body: [
            ...
            'A legal requirement follows from regulation and cannot be waived — for example professional competence for work on electrical equipment, or the occupational health assessment corresponding to the work category. These are requirements of Czech law.',
        ...
        },
        {
          ...
          body: [
            'Alongside the requirements, a brief needs the information that decides whether a suitable person will consider the offer at all: the shift pattern, the location and how reachable the site is, the form and length of training, and who the new person will report to.',
  ...
  'direct-sourcing': {
    en: {
      ...
      description:
        'Direct sourcing for specialist roles: the difference between active and passive candidates, how an approach runs, discretion and candidate data, and what the employer has to supply.',
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            'One more thing belongs in the open: under Czech law, employment mediation requires a permit under the Employment Act, and no fee for mediation may be sought from the candidate. The cost is borne by the employer, never by the person approached.',
          ],
        },
        {
  ...
  'hard-to-fill-roles': {
    en: {
      ...
      description:
        'A step-by-step diagnostic for a specialist role that stays open: contradictions in the profile, inherited requirements, the one real constraint, losses inside your own process, and what the candidate compares you against.',
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            'Requirements in advertisements are inherited. The text was written during the last recruitment, a previous manager added their preferences, and nobody has since compared it with the actual work.',
  ...
  'time-to-hire': {
    en: {
      ...
      description:
        'We do not promise a date for filling a role. What the timeline is made of: notice periods, certificates and qualifications, your own decision loop, relocation, and state permit procedures.',
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            'Accommodation and transport are therefore worth settling before approaching people outside the region, not at the point where a candidate is weighing an offer. The terms, the price and what it includes belong in the offer from the start — negotiating housing afterwards can move a start date considerably.',
          ],
        },
        {
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            'The levers include a sound start and adaptation, conditions that are clear and fair, management and feedback, opportunities to develop, and recognition. In manual and shift operations the stability of rosters and practical facilities matter as well.',
        ...
        },
        {
          heading: 'What you should be able to decide',
          body: [
            'Having thought retention through, you should be able to say which phases of the employee life cycle to invest in — recruitment, onboarding, development — and how to track whether people stay. Retention then becomes part of ordinary management rather than a crisis measure.',
