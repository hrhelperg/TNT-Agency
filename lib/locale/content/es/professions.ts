...
export const ES_PROFESSIONS: LocaleCorpus = {
  'work-for-engineers': {
    es: {
      ...
      description:
        'Ingenieros y especialistas técnicos son el perfil con el camino legal más abierto en Chequia: el programa de trabajador altamente cualificado no tiene limitación territorial. Qué significa en la práctica.',
      h1: 'Trabajar como ingeniero',
      intro:
        'Para ingenieros y especialistas técnicos existe un camino que no existe para otros perfiles. El Programa de trabajador altamente cualificado no tiene limitación de país de origen, lo que lo hace accesible a candidatos latinoamericanos, siempre que la función concreta y el empleador cumplan las condiciones.',
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            'El programa no se aplica automáticamente a quien tiene un título de ingeniería. Lo que determina la aplicabilidad es la clasificación de la función concreta, el empleador y las demás condiciones del programa.',
        ...
        },
        {
          ...
          body: [
            'Reclutamos para necesidades reales de empleadores checos. Las áreas siguientes son las que aparecen con más frecuencia; no son una lista de posiciones abiertas, y no publicamos posiciones en este sitio.',
          ],
          list: {
            items: [
        ...
        },
        {
          ...
          body: [
            'Participar en el programa afecta a la tramitación, no al conjunto de requisitos. Siguen haciendo falta un empleador, un contrato, un puesto registrado, los documentos y la resolución de la autoridad checa.',
      ...
      sections: [
        {
          ...
          body: [
            'El programa de trabajador altamente cualificado cubre las clases CZ-ISCO 1 a 3. Funciones técnicas de nivel medio, incluida parte de las funciones de mantenimiento y automatización, pueden alcanzar la clase 3.',
            'Oficios como la soldadura y el mecanizado CNC se clasifican normalmente en las clases 7 y 8. Esas clases pertenecen al otro programa, del que ningún país de América Latina forma parte, y por tanto no tienen vía de programa disponible.',
          ],
          freshness: 'procedural',
        },
        {
        ...
        },
        {
          ...
          body: [
            'Las funciones siguientes aparecen con frecuencia entre las necesidades de los empleadores con los que trabajamos. No son posiciones abiertas: no publicamos puestos en este sitio.',
          ],
          list: {
            items: [
  ...
  'work-in-manufacturing': {
    es: {
      ...
      description:
        'Producción, ensamblaje y operación de máquinas en Chequia: por qué el programa de trabajador cualificado no está disponible para candidatos latinoamericanos y cuál es el camino legal que queda.',
      ...
      sections: [
        {
          heading: 'El programa de trabajador cualificado no se aplica',
          body: [
  ...
  'work-in-logistics': {
    es: {
      ...
      intro:
        'Esta es el área con la base legal más estrecha de toda esta sección, y sería deshonesto presentarla de otra forma. Hay demanda real de trabajadores de almacén y distribución en Chequia, y a la vez es el perfil para el que un candidato latinoamericano tiene menos caminos disponibles.',
      breadcrumb: 'Trabajar en logística',
      sections: [
        {
          heading: 'Ningún programa estatal cubre este caso',
          body: [
            'Buena parte de las funciones de almacén y distribución se clasifica en las clases CZ-ISCO 8 y 9. El programa de trabajador cualificado cubre las clases 4 a 8 — la clase 9 queda fuera por definición — y además se aplica a una lista de países que no incluye a ningún país de América Latina.',
            'El programa de trabajador altamente cualificado cubre las clases 1 a 3 y no alcanza estas funciones. Es decir: no hay vía de programa por ninguno de los dos lados.',
          ],
          freshness: 'procedural',
        },
        {
          ...
          body: [
            'Queda la tarjeta de empleado estándar, con todas sus condiciones: empleador, puesto registrado, contrato, documentos y resolución de la autoridad. Las exigencias de cualificación y las condiciones del puesto suelen ser precisamente el punto más difícil de cumplir en esta franja.',
        ...
        },
        {
          ...
          body: [
            ...
            'Si además tiene experiencia técnica — mantenimiento, manejo de montacargas con habilitación, operación de equipos, calidad — conviene indicarlo en la postulación: puede abrir un encuadre distinto.',
          ],
        },
      ],
  ...
  'healthcare-regulated-professions': {
    es: {
      ...
      description:
        'Médicos, enfermeros y otras profesiones de la salud en Chequia: reconocimiento de la cualificación, prueba de aptitud (aprobační zkouška), exigencia de checo y qué no puede hacer una agencia de reclutamiento.',
      ...
      sections: [
        {
          heading: 'La habilitación para ejercer es el obstáculo, no el visado',
          body: [
            'Para la mayoría de los perfiles de salud, la clasificación de la profesión cae en las franjas que alcanza el programa de trabajador altamente cualificado, lo que hace la parte migratoria comparativamente más accesible.',
        ...
        },
        {
          ...
          body: [
            ...
            'La prueba verifica conocimientos teóricos, conocimiento del sistema sanitario checo y la capacidad de comunicarse profesionalmente en checo. Es requisito previo acreditar el reconocimiento del título extranjero como equivalente a un programa de máster acreditado en el área de la salud.',
            'El Ministerio de Sanidad resuelve sobre el reconocimiento en un plazo de hasta 240 días desde la entrega completa de los documentos exigidos.',
          ],
          freshness: 'procedural',
        },
        {
          ...
          body: [
            ...
            'Para quien obtuvo la cualificación fuera de la Unión Europea, del Espacio Económico Europeo y de Suiza, el reconocimiento está igualmente condicionado a aprobar la prueba de aptitud.',
          ],
          freshness: 'procedural',
        },
        {
