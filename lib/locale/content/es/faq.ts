...
export const ES_FAQ: LocaleCorpus = {
  'candidate-faq': {
    es: {
      ...
      description:
        'Respuestas directas sobre trabajar en Chequia: tarjeta de empleado, acuerdo UE–Mercosur, exención de visado, plazos, costos y qué puede y no puede hacer TalentPartnerID.',
      ...
      sections: [
        {
          ...
          body: [
            ...
            'No concede a los ciudadanos de países de Mercosur el derecho general a tomar un empleo en la Unión Europea. Para trabajar en Chequia sigue siendo necesaria una autorización checa: normalmente la tarjeta de empleado (zaměstnanecká karta) o, cuando la función y el empleador cumplan las condiciones, el programa de trabajador altamente cualificado.',
          ],
          freshness: 'procedural',
        },
        {
          heading: '¿Puedo entrar como turista y buscar trabajo durante 90 días?',
          body: [
            'Entrar, sí, si su nacionalidad está exenta de visado para estancias cortas. Trabajar, no: la exención vale siempre que la finalidad del viaje no sea una actividad remunerada.',
            'Buscar trabajo no es lo mismo que trabajar, pero empezar a trabajar durante una estancia turística es trabajo no autorizado, con consecuencias tanto para el trabajador como para el empleador.',
          ],
          freshness: 'procedural',
        },
        {
          heading: '¿Los países latinoamericanos participan en el Programa de trabajador cualificado?',
          body: [
        ...
        {
          heading: '¿TalentPartnerID garantiza un visado de dos años?',
          body: [
            'No, y nadie puede. TalentPartnerID no expide visados ni permisos de residencia — quien decide es la autoridad checa.',
        ...
        },
        {
          ...
          body: [
            ...
            'Hay costos que no son nuestros y que siguen existiendo: tasas administrativas de la solicitud, traducciones, legalización de documentos y el viaje. Esos importes los fijan terceros y deben consultarse en las fuentes oficiales.',
          ],
        },
        {
          heading: '¿Tienen una lista de puestos abiertos?',
          body: [
            'No publicamos una lista de puestos en este sitio. Las necesidades llegan de empleadores y cambian, y una lista desactualizada haría que alguien planificara una mudanza de país sobre la base de una posición ya cubierta.',
            'Lo que hacemos es evaluar la postulación y contactarle cuando haya correspondencia real con una necesidad concreta.',
          ],
        },
        {
        ...
        },
        {
          ...
          body: [
            'No. No cobramos al candidato y no tenemos intermediarios que cobren en nuestro nombre para asegurar un puesto, un visado o prioridad en la fila.',
