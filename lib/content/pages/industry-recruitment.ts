...
export const PRACOVNICI_DO_VYROBY: SeoPage = {
  ...
  sections: [
    ...
    {
      heading: 'Formy pracovněprávního vztahu u nástupních pozic ve výrobě',
      body: [
        'Zákoník práce nabízí u nástupních výrobních pozic více forem vztahu — pracovní poměr na dobu určitou i neurčitou a dohody mimo pracovní poměr (DPP a DPČ). Volba formy určuje rozsah práv, ochrany i administrativy a měla by odpovídat povaze práce, ne jen rychlosti obsazení.',
        'Pro sezónní a nárazovou potřebu, typickou právě pro nástupní výrobu, se hodí pracovní poměr na dobu určitou; jeho opakování a řetězení ale zákoník práce omezuje (§ 39) — nelze jej neomezeně prodlužovat namísto stálého poměru. Zkušební doba podle zákoníku práce dává u rychle zaučovaných pozic oběma stranám prostor ověřit spolupráci na začátku.',
        'U agenturního přidělení platí, že zprostředkování zaměstnání podléhá podle zákona o zaměstnanosti povolení a zákoník práce vyžaduje rovné zacházení: pracovní a mzdové podmínky dočasně přiděleného zaměstnance nesmí být horší než u srovnatelného kmenového zaměstnance uživatele (§ 309). Držitelem povolení ke zprostředkování je v tomto ekosystému agentura, nikoli tato platforma.',
      ],
      bullets: [
        'Při nástupu vzniká povinnost přihlásit zaměstnance k sociálnímu (ČSSZ) a zdravotnímu pojištění; u hromadného nástupu je vhodné to připravit s předstihem.',
        'Dodržování zvolené formy vztahu, rovného zacházení i podmínek BOZP kontroluje Státní úřad inspekce práce.',
        'Zastřené zprostředkování zaměstnání nebo obcházení pravidel řetězení může být postižitelné — formu je vhodné volit podle skutečné povahy práce.',
      ],
    },
  ],
  faq: [
    { q: 'Jaká forma pracovněprávního vztahu se hodí pro sezónní nástupní pozice ve výrobě?', a: 'Pro nárazovou a sezónní potřebu se nabízí pracovní poměr na dobu určitou nebo agenturní přidělení; dohody mimo pracovní poměr (DPP, DPČ) mají užší rozsah a spíše doplňkovou roli. Volbu posuzujte podle skutečné povahy práce a pravidel zákoníku práce — opakování a řetězení poměrů na dobu určitou je omezené. Konkrétní řešení nezaručujeme, záleží na okolnostech provozu.' },
    { q: 'Platí pro agenturní pracovníky ve výrobě stejné podmínky jako pro kmenové zaměstnance?', a: 'Zákoník práce vyžaduje rovné zacházení: pracovní a mzdové podmínky dočasně přiděleného zaměstnance nesmí být horší než u srovnatelného zaměstnance uživatele. Zprostředkování zaměstnání navíc smí podle zákona o zaměstnanosti provozovat jen držitel příslušného povolení.' },
  ...
  sources: [SRC.zakonOZamestnanosti, SRC.zakonikPrace, SRC.zakonSocialni, SRC.zakonZdravotni, SRC.cssz, SRC.suip, SRC.upcr, SRC.mpsv],
  internalLinks: [
    employerHubLink,
    { href: '/pracovnici-pro-vyrobu', label: 'Pracovníci pro výrobu: přehled' },
...
export const PRACOVNICI_DO_SKLADU: SeoPage = {
  ...
  sections: [
    ...
    {
      heading: 'Právní formy zajištění nástupních a sezónních pozic',
      body: [
        'Nástupní a sezónní skladové pozice lze právně zajistit několika cestami: pracovním poměrem (u sezónní potřeby často na dobu určitou), dohodami o pracích konaných mimo pracovní poměr (DPP, DPČ) a agenturním zaměstnáváním formou dočasného přidělení. Rámec upravuje zákoník práce a zákon o zaměstnanosti.',
        'Dohody mimo pracovní poměr se hodí pro menší nebo nárazový rozsah práce; jejich přípustný rozsah je zákoníkem práce omezen a konkrétní limity je nutné ověřit v platném znění zákona (čísla zde neuvádíme). Pro objemové pokrytí špiček slouží agenturní zaměstnávání — agentura dočasně přiděluje své zaměstnance k uživateli a zprostředkování zaměstnání smí podle zákona o zaměstnanosti poskytovat pouze subjekt s příslušným povolením.',
        'Bez ohledu na zvolenou formu se pracovní smlouva i dohody uzavírají písemně a vztah má být sjednán před zahájením práce; výkon práce bez uzavřeného vztahu spadá pod nelegální práci podle zákona o zaměstnanosti. U dočasně přidělených zaměstnanců vyžaduje zákoník práce srovnatelné pracovní a mzdové podmínky jako u srovnatelných kmenových zaměstnanců uživatele.',
      ],
      bullets: [
        'Volbu formy má řídit skutečná povaha potřeby (stálá vs. dočasná, pravidelná vs. nárazová), nikoli snaha obejít pravidla.',
        'Výkon práce bez řádně uzavřeného vztahu podléhá kontrole Státního úřadu inspekce práce.',
        'Oficiální výklad a formuláře poskytují MPSV a Úřad práce ČR.',
      ],
    },
  ],
  faq: [
    { q: 'Jaké právní formy lze u nástupních skladových pozic využít?', a: 'Nejčastěji pracovní poměr (u sezónní potřeby často na dobu určitou), dohody mimo pracovní poměr (DPP, DPČ) pro menší rozsah práce a agenturní zaměstnávání formou dočasného přidělení pro nárazové objemy. Volba se řídí povahou potřeby a zákoníkem práce.' },
    { q: 'Musí být smlouva nebo dohoda uzavřena písemně před nástupem?', a: 'Ano. Pracovní smlouva i dohody mimo pracovní poměr se uzavírají písemně a vztah má být sjednán před zahájením práce. Výkon práce bez uzavřeného vztahu je podle zákona o zaměstnanosti nelegální prací a podléhá kontrole inspekce práce. Přesné náležitosti patří do platného znění zákona.' },
  ...
  sources: [SRC.zakonOZamestnanosti, SRC.zakonikPrace, SRC.suip, SRC.upcr, SRC.mpsv],
  internalLinks: [
    employerHubLink,
    { href: '/skladnici', label: 'Skladníci: přehled' },
    { href: '/skladovi-pracovnici', label: 'Skladoví pracovníci' },
...
export const PRACOVNICI_DO_LOGISTIKY: SeoPage = {
  ...
  sections: [
    ...
    {
      heading: 'Právní rámec flexibilního zajištění špiček v logistice',
      body: [
        'Logistické sezónní špičky lze legálně pokrýt více formami: pracovním poměrem na dobu určitou, dohodami mimo pracovní poměr (DPP a DPČ) a dočasným přidělením přes agenturu práce — každá se řídí jinými pravidly podle zákoníku práce a zákona o zaměstnanosti. Řetězení pracovních poměrů na dobu určitou i rozsah dohod jsou zákoníkem práce omezené; přesné limity je třeba ověřit v aktuálním znění zákona a konkrétní čísla zde neuvádíme.',
        'U dočasného přidělení musí mít agenturní pracovník srovnatelné pracovní a mzdové podmínky jako kmenový zaměstnanec na obdobné pozici a agentura práce musí mít povolení ke zprostředkování zaměstnání; toto povolení drží v našem ekosystému agentura práce, samotná platforma jím není.',
        'Povinnosti v oblasti BOZP vůči pracovníkům na svém pracovišti nese provozovatel pracoviště, u agenturního přidělení uživatel, bez ohledu na formu úvazku — vstupní školení, seznámení s riziky provozu a ochranné pomůcky; u noční práce a rizikových manipulačních pozic přistupují pracovnělékařské prohlídky.',
      ],
      bullets: [
        'Každé nasazení musí být řádně přihlášené k sociálnímu a zdravotnímu pojištění a evidované, jinak může jít o nelegální práci.',
        'Dodržování pracovněprávních povinností kontroluje Státní úřad inspekce práce.',
        'Volbu formy je vhodné řídit délkou a opakovatelností potřeby — jednorázová výpomoc, opakovaná sezónní špička a dlouhodobě kolísavý objem vedou k odlišným řešením.',
      ],
    },
  ],
  faq: [
    { q: 'Jakou formou pokrýt sezónní špičku v logistice?', a: 'Zákon nabízí několik cest — pracovní poměr na dobu určitou, dohody mimo pracovní poměr (DPP a DPČ) nebo dočasné přidělení přes agenturu práce. Volba závisí na délce a opakovatelnosti potřeby; každá forma má svá pravidla podle zákoníku práce a zákona o zaměstnanosti. Univerzální „nejlepší“ řešení neexistuje.' },
    { q: 'Musí mít agenturní pracovník stejné podmínky jako naši kmenoví lidé?', a: 'U dočasného přidělení vyžaduje zákoník práce srovnatelné pracovní a mzdové podmínky vůči kmenovému zaměstnanci na obdobné pozici. Agentura práce navíc musí mít povolení ke zprostředkování zaměstnání; v našem ekosystému je jeho držitelem agentura, nikoli tato platforma.' },
  ...
  sources: [SRC.zakonOZamestnanosti, SRC.zakonikPrace, SRC.zakonBozp, SRC.zakonInspekcePrace, SRC.zakonSocialni, SRC.zakonZdravotni, SRC.cssz, SRC.upcr, SRC.mpsv, SRC.czso],
  internalLinks: [
    employerHubLink,
...
export const PRACOVNICI_PRO_POTRAVINARSKOU_VYROBU: SeoPage = {
  ...
  sections: [
    ...
    {
      heading: 'Chlazené a mrazírenské provozy a ochrana zdraví při práci',
      body: [
        'Část zpracování, výroby a expedice v potravinářství běží v chlazených, mrazírenských nebo jinak teplotně řízených prostorech (maso, mléčné a mražené výrobky, chladicí řetězec) — prostředí, které se liší od běžné výrobní haly a klade zvláštní nároky na ochranu zdraví.',
        'Podle zákoníku práce má zaměstnavatel povinnost zajišťovat bezpečné a zdraví neohrožující pracovní prostředí a přizpůsobovat mu organizaci práce; tato povinnost dopadá i na práci v nízkých teplotách. Zákoník práce zároveň ukládá poskytovat osobní ochranné pracovní prostředky bezplatně tam, kde to prostředí a rizika vyžadují, a v zákonem stanovených případech i ochranné nápoje; konkrétní rozsah a podmínky určují prováděcí předpisy, které je třeba ověřit.',
        'Zákon o zajištění dalších podmínek BOZP (č. 309/2006 Sb.) a navazující předpisy řeší podmínky ochrany zdraví včetně zátěžových faktorů prostředí, jako je teplota a vlhkost. U rizikových prací a prací se zátěžovými faktory vyžadují zákoník práce a předpisy o pracovnělékařských službách posouzení zdravotní způsobilosti; zákoník práce upravuje i přestávky v práci a bezpečnostní přestávky.',
      ],
      bullets: [
        'U práce v chladu je vhodné počítat s posouzením zdravotní způsobilosti při nástupu, s režimem práce a odpočinku a se zastupitelností.',
        'Dodržování podmínek BOZP dozoruje Státní úřad inspekce práce; metodické informace zveřejňuje MPSV.',
        'Práci v chladu, ochranné prostředky a případné zdravotní požadavky je vhodné uvést už v inzerci a při zaškolení, aby se předešlo nedorozuměním a zbytečné fluktuaci.',
      ],
    },
  ],
  faq: [
    { q: 'Musí zaměstnavatel poskytovat ochranné prostředky pro práci v chladu?', a: 'Zákoník práce ukládá zaměstnavateli poskytovat osobní ochranné pracovní prostředky bezplatně tam, kde to prostředí a rizika vyžadují, a v zákonem stanovených případech i ochranné nápoje. Konkrétní rozsah a podmínky stanoví prováděcí předpisy a je vhodné je ověřit podle charakteru provozu.' },
    { q: 'Platí pro chlazené a mrazírenské provozy zvláštní povinnosti BOZP?', a: 'Zaměstnavatel má podle zákoníku práce a předpisů o BOZP zajišťovat bezpečné a zdraví neohrožující pracovní prostředí, včetně zohlednění zátěžových faktorů, jako je nízká teplota. Konkrétní parametry a opatření vycházejí z prováděcích předpisů a jejich dodržování dozoruje Státní úřad inspekce práce.' },
  ...
  sources: [SRC.zakonOZamestnanosti, SRC.zakonikPrace, SRC.zakonBozp, SRC.zakonInspekcePrace, SRC.suip, SRC.upcr, SRC.mpsv],
  internalLinks: [
    employerHubLink,
...
export const PRACOVNICI_PRO_AUTOMOTIVE: SeoPage = {
  ...
  sections: [
    ...
    {
      heading: 'Nepřetržitý provoz a rozvržení pracovní doby na lince',
      body: [
        'Automotive typicky běží ve vícesměnném nebo nepřetržitém provozu; zákoník práce rozlišuje rovnoměrné a nerovnoměrné rozvržení pracovní doby a stanoví rámec pro směnné i nepřetržité provozy, do kterého musí rozvrh linky zapadnout.',
        'Konto pracovní doby je podle zákoníku práce zvláštní způsob rozvržení pracovní doby, který lze zavést jen kolektivní smlouvou nebo vnitřním předpisem; hodí se pro provozy s kolísáním výroby (náběhy nových modelů, výkyvy odvolávek), protože umožňuje vyrovnávat odpracovanou dobu ve vyrovnávacím období. Noční práce a noční směna mají v zákoníku práce vlastní úpravu a zaměstnancům pracujícím v noci náleží zvláštní ochrana, s ohledem na BOZP včetně posouzení zdravotní způsobilosti.',
        'Nepřetržitý odpočinek mezi směnami a v týdnu i přestávky v práci jsou zákoníkem práce stanovené minimální standardy, které musí rozvrh směn na lince respektovat (konkrétní délky zde neuvádíme). Za práci v noci, o víkendu, ve svátek a přesčas náleží zaměstnanci příplatky podle zákoníku práce; konkrétní sazby neuvádíme, odvíjejí se od zákonné úpravy a případné kolektivní smlouvy.',
      ],
      bullets: [
        'Dodržování pracovní doby, odpočinku a její evidence kontroluje inspekce práce podle zákona o inspekci práce (SÚIP a oblastní inspektoráty).',
        'Agenturně přiděleným pracovníkům na lince náleží srovnatelné podmínky pracovní doby a odpočinku jako kmenovým zaměstnancům.',
        'Rozvrh směn nastavuje zaměstnavatel v mezích zákona; formu je vhodné volit podle skutečného provozu.',
      ],
    },
  ],
  faq: [
    { q: 'Jak zákon upravuje nepřetržitý nebo vícesměnný provoz na automotive lince?', a: 'Zákoník práce rozlišuje rovnoměrné a nerovnoměrné rozvržení pracovní doby a stanoví pravidla pro směnné i nepřetržité provozy včetně minimálního odpočinku mezi směnami a v týdnu. Konkrétní rozvrh směn nastavuje zaměstnavatel v mezích zákona; přesné délky zde neuvádíme.' },
    { q: 'K čemu v automotive slouží konto pracovní doby?', a: 'Je to zvláštní způsob rozvržení pracovní doby podle zákoníku práce, který lze zavést jen kolektivní smlouvou nebo vnitřním předpisem a který umožňuje vyrovnávat odpracované hodiny ve vyrovnávacím období. Hodí se pro provozy s kolísáním výroby, jako jsou náběhy modelů nebo výkyvy odvolávek.' },
