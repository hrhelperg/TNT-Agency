...
export const NABOR_ZAMESTNANCU_PARDUBICE: SeoPage = {
  ...
  sections: [
    ...
    {
      heading: 'Úřady a zákonné povinnosti při náboru v Pardubickém regionu',
      body: [
        'Nábor a agenturní zaměstnávání upravuje zákon o zaměstnanosti; zprostředkování zaměstnání smí vykonávat jen agentura s povolením podle § 14, které vydává Generální ředitelství Úřadu práce ČR — existenci povolení si zaměstnavatel využívající agenturní kapacitu může u Úřadu práce ověřit před spoluprací. Agendu zaměstnanosti a evidenci vede Úřad práce ČR prostřednictvím kontaktních pracovišť v regionu, metodicky ji zastřešuje MPSV.',
        'Přijetí zaměstnance provázejí přihlašovací povinnosti v zákonných lhůtách: k pojistnému na sociální zabezpečení u okresní správy sociálního zabezpečení (OSSZ), územního pracoviště ČSSZ, a k veřejnému zdravotnímu pojištění u příslušné zdravotní pojišťovny. Dodržování BOZP a pracovních podmínek podléhá kontrole; dozor vykonává Státní úřad inspekce práce prostřednictvím místně příslušného oblastního inspektorátu, do jehož působnosti Pardubický kraj spadá.',
        'U náboru cizinců přistupují pobytová a pracovní oprávnění podle zákona o pobytu cizinců (role MV ČR a Úřadu práce), která je nutné vyřešit před nástupem — podrobně na samostatné stránce o zahraničních pracovnících. Rámec zprostředkování zaměstnání je přitom celostátní: povolení agentur vydává ústředně GŘ ÚP, zatímco místní příslušnost se týká jen některých úřadů (ČSSZ, zdravotní pojišťovny, oblastní inspektorát práce).',
      ],
      bullets: [
        'Sídlo poskytovatele náboru samo o sobě zákonné povinnosti zaměstnavatele nemění ani nezakládá jeho oprávnění.',
        'Povolení agentury podle § 14 si lze ověřit u Úřadu práce ČR ještě před zahájením spolupráce.',
        'Přihlášení k pojistnému řeší místně příslušná OSSZ (ČSSZ) a zdravotní pojišťovna zaměstnance.',
      ],
    },
  ],
  faq: [
    { q: 'Které úřady řeší nábor a zaměstnávání v Pardubickém kraji?', a: 'Agendu zaměstnanosti a zaměstnávání cizinců zajišťuje Úřad práce ČR prostřednictvím kontaktních pracovišť v regionu, metodicky ji zastřešuje MPSV. Dozor nad BOZP a pracovními podmínkami vykonává Státní úřad inspekce práce přes místně příslušný oblastní inspektorát práce. Přihlášení k pojistnému řeší okresní správa sociálního zabezpečení (OSSZ) a příslušná zdravotní pojišťovna.' },
    { q: 'Musí mít pracovní agentura, se kterou spolupracujeme, povolení?', a: 'Ano. Zprostředkování zaměstnání smí podle zákona o zaměstnanosti provádět jen agentura s povolením podle § 14, které vydává Generální ředitelství Úřadu práce ČR. Zaměstnavatel si může existenci tohoto povolení ověřit ještě před zahájením spolupráce.' },
  ...
  sources: [SRC.zakonOZamestnanosti, SRC.zakonSocialni, SRC.zakonZdravotni, SRC.zakonBozp, SRC.zakonInspekcePrace, SRC.zakonOPobytuCizincu, SRC.cssz, SRC.suip, SRC.upcr, SRC.mpsv],
  internalLinks: [
    employerHubLink,
    { href: '/pracovnici-pardubice', label: 'Pracovníci Pardubice: kde hledat' },
    { href: '/pracovnici-do-logistiky', label: 'Pracovníci do logistiky' },
    { href: '/povinnosti-zamestnavatele', label: 'Povinnosti zaměstnavatele při náboru' },
...
export const NABOR_ZAMESTNANCU_HRADEC_KRALOVE: SeoPage = {
  ...
  sections: [
    ...
    {
      heading: 'Spádová dojížďka a místo výkonu práce ve smlouvě',
      body: [
        'V Hradci Králové jako regionálním centru a v jeho spádové oblasti, která se překrývá s Pardubicemi, řada kandidátů do práce dojíždí; nábor napříč touto spádovou oblastí je vhodné promítnout nejen do inzerce, ale i do nastavení pracovního vztahu.',
        'Zákoník práce (č. 262/2006 Sb.) řadí mezi podstatné náležitosti pracovní smlouvy druh práce a místo, případně místa, výkonu práce; jejich přesné vymezení určuje, kam je zaměstnanec povinen pravidelně docházet. Běžná cesta do sjednaného místa výkonu práce je dojížďkou zaměstnance; cestovní náhrady podle zákoníku práce vznikají zpravidla až při vyslání mimo sjednané místo (pracovní cesta), proto se vyplatí místo výkonu práce vymezit jednoznačně a předejít nedorozuměním u dojíždějících.',
        'Působí-li zaměstnavatel na více provozovnách na ose Hradec Králové–Pardubice, je vhodné to transparentně sdělit už při náboru a promítnout do smluvních podmínek tak, aby odpovídaly skutečnému výkonu práce. U provozních a výrobních rolí bývá výkon vázán na konkrétní pracoviště; u některých kvalifikovaných a administrativních profesí umožňuje druh práce i práci na dálku či kombinovaný režim, pokud jsou sjednány ve smlouvě nebo dohodě v mezích zákoníku práce.',
      ],
      bullets: [
        'Místo výkonu práce patří mezi podstatné náležitosti pracovní smlouvy — vymezte je jednoznačně.',
        'Konkrétní rozsah náhrad i případný režim práce na dálku závisí na dohodě stran a aktuálním znění předpisů.',
        'Obecný rámec dává zákoník práce; institucionální přehled a nástroje poskytují MPSV a Úřad práce ČR.',
      ],
    },
  ],
  faq: [
    { q: 'Musíme dojíždějícím kandidátům z okolí platit cestu do práce?', a: 'Běžná cesta do sjednaného místa výkonu práce je dojížďkou zaměstnance. Cestovní náhrady podle zákoníku práce vznikají zpravidla až při vyslání mimo sjednané místo, tedy při pracovní cestě. Proto se vyplatí místo výkonu práce ve smlouvě vymezit jednoznačně.' },
    { q: 'Jak ve smlouvě zohlednit, že působíme v Hradci Králové i v Pardubicích?', a: 'Zákoník práce řadí místo výkonu práce mezi podstatné náležitosti pracovní smlouvy. Pokud zaměstnanec může působit na více pracovištích, je vhodné to transparentně sdělit už při náboru a promítnout do smluvních podmínek, aby odpovídaly skutečnému výkonu práce.' },
  ...
  internalLinks: [
    ...
    { href: '/pracovnici-pro-vyrobu', label: 'Pracovníci pro výrobu' },
    { href: '/trh-prace-kralovehradecky-kraj', label: 'Trh práce v Královéhradeckém kraji' },
    { href: '/pracovnici-pardubice', label: 'Pracovníci v Pardubicích' },
    jakNajitLink,
    naborLink,
    empFaqLink,
  ],
