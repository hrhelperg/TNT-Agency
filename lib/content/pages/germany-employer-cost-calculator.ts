  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'Dále kalkulačka odmítá případy, které z čísel poznat nelze a na které se proto ptá: soukromé zdravotní pojištění, úředníky, souběh zaměstnání, pracující důchodce, hornické pojištění, profesní komory, kurzarbeit, jednorázové výplaty, přeshraniční situace a nepeněžní plnění. U každého případu uvádí důvod.',
