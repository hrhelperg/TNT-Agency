...
export const UNSUPPORTED_CASES: readonly UnsupportedCase[] = [
  ...
  },
  {
    ...
    reasonDe:
      'Im Baugewerbe kommen die Winterbeschäftigungs-Umlage nach § 354 SGB III und die Beiträge zu den Sozialkassen hinzu. Für 2026 senkt § 3a WinterbeschV den Umlagesatz im Baugewerbe befristet auf 1 % — davon 0,6 % Arbeitgeber, 0,4 % Arbeitnehmer — statt der 2 % aus § 3 Absatz 1 Nummer 1 mit der Aufteilung 1,2/0,8 nach § 3 Absatz 2 Nummer 1; für Gerüstbau, Dachdecker und Garten- und Landschaftsbau gelten weiter die Sätze des § 3. Die Sozialkassenbeiträge folgen dagegen den Tarifverträgen und unterscheiden sich je nach Branche. Beides ist hier nicht abgebildet, die Arbeitgeberkosten lägen also höher als berechnet.',
    reasonEn:
      'Construction adds the Winterbeschäftigungs-Umlage under § 354 SGB III and contributions to the sector’s social funds. FOR 2026 § 3a WinterbeschV temporarily cuts the building-trade levy to 1 % — 0.6 % employer, 0.4 % employee — instead of the 2 % in § 3 Absatz 1 Nummer 1, split 1.2/0.8 by § 3 Absatz 2 Nummer 1; scaffolding, roofing and landscaping keep the § 3 rates. The social-fund contributions follow collective agreements and differ by trade. Neither is modelled here, so employer cost would be higher than calculated.',
    reasonCs:
      'Ve stavebnictví přistupuje zimní odvod podle § 354 SGB III a příspěvky do oborových sociálních kas. Pro rok 2026 snižuje § 3a WinterbeschV sazbu odvodu ve stavebnictví dočasně na 1 % — z toho 0,6 % zaměstnavatel a 0,4 % zaměstnanec — místo 2 % podle § 3 odst. 1 č. 1 s rozdělením 1,2/0,8 podle § 3 odst. 2 č. 1; pro lešenářství, pokrývačství a zahradní a krajinářskou tvorbu platí dál sazby § 3. Příspěvky do sociálních kas se naproti tomu řídí kolektivními smlouvami a liší se podle oboru. Ani jedno zde není zahrnuto, náklady zaměstnavatele by proto byly vyšší, než kolik zde vychází.',
  },
  {
